...
# check_point = ((650, 690), (250, 475), (1030, 270), (190, 200), (1250, 120), (1200, 660))
...
class Car:
    def __init__(self, car_file, map_file, pos):
        ...
        self.distance = 0
        self.time_spent = 0
        self.radars_array = [-40, 0, 40] # [180, -90, -40, -15, 0, 15, 40, 90]
        for d in self.radars_array:
            self.check_radar(d)
    ...
    def check_radar_for_draw(self, degree):
        max_len = 300
        if (degree == 180 or degree == 90 or degree == -90):
            max_len = 150
        len = 0
        x = int(self.center[0] + math.cos(math.radians(360 - (self.angle + degree))) * len)
        y = int(self.center[1] + math.sin(math.radians(360 - (self.angle + degree))) * len)
...
class PyGame2D:
    ...
    def action(self, action):
        ...
        for d in self.car.radars_array:
    ...
    def view(self):
        ...
        for d in [-40, 0, 40]: # [180, -90, -40, -15, 0, 15, 40, 90]
